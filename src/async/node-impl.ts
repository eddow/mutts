...
class PatchedPromise<T> extends OriginalPromise<T> {
	static get [Symbol.species]() { return PatchedPromise }
...
// Bind static methods
PatchedPromise.resolve = originalMethods.resolve
PatchedPromise.reject = originalMethods.reject
PatchedPromise.all = originalMethods.all
...
globalThis.Promise = PatchedPromise as any
